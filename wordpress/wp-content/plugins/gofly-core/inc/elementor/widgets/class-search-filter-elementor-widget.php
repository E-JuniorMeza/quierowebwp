            ...
            <div class="filter-wrapper">
                <div class="container">
                    ...
                    <div class="filter-input-wrap">
                        <!-- Tour  -->
                        <form class="filter-input<?php echo $settings['gofly_search_filter_genaral_tabs_tour_set_default_switcher'] == 'yes' ? ' show' : '' ?>" method="get" action="<?php echo get_post_type_archive_link('tour'); ?>">
                        ...
                        <!-- Hotel  -->
                        <form class="filter-input two<?php echo $settings['gofly_search_filter_genaral_tabs_hotels_default_switcher'] == 'yes' ? ' show' : '' ?>" method="get" action="<?php echo get_post_type_archive_link('hotel'); ?>">
                            <div class="single-search-box">
                                <svg width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
                                    <g>
                                        <path
                        ...
                        <!-- Visa -->
                        <form class="filter-input two<?php echo $settings['gofly_search_filter_genaral_tabs_visa_default_switcher'] == 'yes' ? ' show' : '' ?>" method="get" action="<?php echo get_post_type_archive_link('visa'); ?>">
                            <div class="single-search-box">
                                <?php
                        ...
                        <!-- Experience -->
                        <form class="filter-input<?php echo $settings['gofly_search_filter_genaral_tabs_experience_default_switcher'] == 'yes' ? ' show' : '' ?>" method="get" action="<?php echo get_post_type_archive_link('experience'); ?>">
                            <div class="single-search-box">
                                <?php

...
<div class="list-grid-product-wrap">
    <div id="sidebar_filter_hotel" class="row gy-md-5 gy-4">
        <?php
        if (have_posts()) {
        ...
        ?>
                <div class="<?php echo Egns_Helper::egns_get_theme_option('hotel_sidebar_filter') == false ? 'col-md-6' : 'col-md-6 col-lg-4' ?> item wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">

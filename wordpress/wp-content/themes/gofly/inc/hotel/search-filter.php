<div class="filter-wrapper hotel mb-100">
    <div class="container">
        <div class="filter-input-wrap">
            <h6><?php echo esc_html__('Find Your Flexible Accommodation', 'gofly') ?></h6>
            <form class="filter-input two show" method="get" action="<?php echo get_post_type_archive_link('hotel'); ?>">
                <div class="single-search-box">
                    ...
                    <div class="custom-select-dropdown destination-dropdown">
                        <div class="input-field-value">
                            <div class="destination">
                                <h6><?php echo esc_html__('Select', 'gofly'); ?></h6>
                                <span><?php echo esc_html__('Destination', 'gofly'); ?></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="custom-select-wrap three">
                        <div class="custom-select-search-area">
                            ...
                            <input type="text" name="ht_location" value="" placeholder="<?php echo esc_attr__('Type Your Destination', 'gofly') ?>">
                        </div>
                        <ul class="option-list-destination">
                            ...
                            ?>
                                            <li data-value="<?php echo esc_attr($child->name); ?>">
                                                <div class="tour">
                ...
                <div class="single-search-box date-field">
                    ...
                    <div class="custom-select-dropdown">
                        <input type="text" name="ht_checkInOutdate" class="hotel-checkin" readonly value="June 16 - June 20">
                ...
                <div class="single-search-box date-field">
                    ...
                    <div class="custom-select-dropdown">
                        <input type="text" class="hotel-checkin" readonly>
                    ...
                    <div class="custom-select-wrap">
                        ...
                        <button type="button" class="primary-btn1 two add-btn">
                            <span>
                                ...
                                <?php echo esc_html__('Add Another Room', 'gofly') ?>
                            </span>
                            <span>
                                <svg width="10" height="10" viewBox="0 0 10 10" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M6 4H10V6H6V10H4V6H0V4H4V0H6V4Z" />
                ...
                <button type="submit" class="primary-btn1">
                    <span>
                        ...
                        <?php echo esc_html__('SEARCH', 'gofly') ?>
                    </span>
                    <span>
                        <svg width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
                            <g>

     ...
     <div class="container-fluid d-flex flex-nowrap align-items-center justify-content-between">
         <div class="logo-and-menu-area">
             ...
             <div class="main-menu">
                 ...
                 <?php \Egns\Helper\Egns_Helper::egns_get_theme_menu('visa-menu', false, '', '<i class="bi-caret-right-fill dropdown-icon"></i><i class="d-lg-none d-flex bi bi-plus dropdown-icon"></i>', 'menu-list', 3) ?>
                 <div class="contact-area d-xl-none d-flex">
                     <?php if (!empty(Egns\Helper\Egns_Helper::egns_get_theme_option('header_eight_info_icon', 'url'))) : ?>
                         <div class="icon">
                             <?php
                                echo Egns\Helper\Egns_Helper::gofly_display_icon_image(Egns\Helper\Egns_Helper::egns_get_theme_option('header_eight_info_icon', 'url'), 'icon-image');
                                ?>
                         </div>
                     <?php endif; ?>
                     <div class="content">
                         <?php if (!empty(Egns\Helper\Egns_Helper::egns_get_theme_option('header_eight_info_label'))) : ?>
                             <span><?php echo esc_html(Egns\Helper\Egns_Helper::egns_get_theme_option('header_eight_info_label')); ?></span>
                         <?php endif; ?>
                         <?php if (!empty(Egns\Helper\Egns_Helper::egns_get_theme_option('header_eight_info_link', 'text'))) : ?>
                             <a href="<?php echo esc_url(Egns\Helper\Egns_Helper::egns_get_theme_option('header_eight_info_link', 'url')); ?>"><?php echo esc_html(Egns\Helper\Egns_Helper::egns_get_theme_option('header_eight_info_link', 'text')); ?></a>
                         <?php endif; ?>
                     </div>
                 </div>
                 <?php if (!empty(Egns\Helper\Egns_Helper::egns_get_theme_option('header_eight_login_button_link_and_text', 'text'))) : ?>
                     <a href="<?php echo esc_url(Egns\Helper\Egns_Helper::egns_get_theme_option('header_eight_login_button_link_and_text', 'url')); ?>" class="primary-btn1 black-bg d-xl-none d-flex">
                         <span>
                             ...
                             <?php echo esc_html(Egns\Helper\Egns_Helper::egns_get_theme_option('header_eight_login_button_link_and_text', 'text')); ?>
                         </span>
                         <span>
                             <svg width="15" height="15" viewBox="0 0 15 15" xmlns="http://www.w3.org/2000/svg">
                                 <g>
         ...
         <div class="nav-right">
             <?php if (!empty(\Egns\Helper\Egns_Helper::egns_get_theme_option('header_eight_language_shortcode'))) : ?>
                 <div class="language-area">
                     <?php
                        if (\Egns\Helper\Egns_Helper::egns_get_theme_option('header_eight_language_enable') == 1) {
                            echo do_shortcode(\Egns\Helper\Egns_Helper::egns_get_theme_option('header_eight_language_shortcode'));
                        }
                        ?>
                 </div>
             <?php endif; ?>
                         ...
                         <form method="get" id="searchform" action="<?php echo esc_url(home_url('/')); ?>" role="<?php echo esc_attr('search') ?>">
                             <div class="search-group">
                                 <div class="form-inner2">
                                     <input type="text" id="s" name="s" placeholder="<?php echo esc_attr__('Find Your Perfect Visa Package', 'gofly') ?>">
                                     <?php if (class_exists('Egns_Core')): ?><input type="hidden" name="post_type" value="visa" /><?php endif; ?>
                                 ...
                                 <ul>
                                     ...
                                     <?php
                                        ...
                                        foreach ($recent_searches as $key => $search) {
                                            ...
                                            $url = add_query_arg(array('s' => $search, 'post_type' => 'visa',), home_url('/'));

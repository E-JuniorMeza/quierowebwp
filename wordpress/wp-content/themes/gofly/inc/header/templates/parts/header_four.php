...
<?php if (Egns\Helper\Egns_Helper::egns_get_theme_option('header_offer_text_switcher') == '1') : ?>
                    ...
                    <div class="top-offer-text-slider-wrap">
                        ...
                        <div class="swiper top-offer-text-slider">
                            <div class="swiper-wrapper">
                                <?php foreach (Egns\Helper\Egns_Helper::egns_get_theme_option('header_four_offer_text_list') as $offer_data) : ?>
                                    <?php if (!empty($offer_data['header_four_offer_text'])) : ?>
                                        <div class="swiper-slide">
                                            <a href="<?php echo esc_url($offer_data['header_four_offer_link']['url']); ?>"><?php echo wp_kses($offer_data['header_four_offer_text'], wp_kses_allowed_html('post')); ?></a>
                                        </div>
                                    <?php endif; ?>
                                <?php endforeach; ?>
                            </div>
        ...
        <div class="logo-and-menu-area">
            ...
            <div class="main-menu">
                ...
                <div class="contact-area d-xl-none d-flex">
                    <?php if (!empty(Egns\Helper\Egns_Helper::egns_get_theme_option('header_four_info_icon', 'url'))) : ?>
                        <div class="icon">
                            <?php
                            echo Egns\Helper\Egns_Helper::gofly_display_icon_image(Egns\Helper\Egns_Helper::egns_get_theme_option('header_four_info_icon', 'url'), 'icon-image');
                            ?>
                        </div>
                    <?php endif; ?>
                    <div class="content">
                        <?php if (!empty(Egns\Helper\Egns_Helper::egns_get_theme_option('header_four_info_label'))) : ?>
                            <span><?php echo esc_html(Egns\Helper\Egns_Helper::egns_get_theme_option('header_four_info_label')); ?></span>
                        <?php endif; ?>
                        <?php if (!empty(Egns\Helper\Egns_Helper::egns_get_theme_option('header_four_info_link', 'text'))) : ?>
                            <a href="<?php echo esc_url(Egns\Helper\Egns_Helper::egns_get_theme_option('header_four_info_link', 'url')); ?>"><?php echo esc_html(Egns\Helper\Egns_Helper::egns_get_theme_option('header_four_info_link', 'text')); ?></a>
                        <?php endif; ?>
                    </div>
                </div>
                <?php if (Egns_Helper::egns_get_theme_option('header_four_login_switcher') == true) : ?>

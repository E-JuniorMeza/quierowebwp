          ...
          <div class="topbar-wrap">
              <div class="logo-and-search-area">
                  ...
                  <?php if (class_exists('Egns_Core')) : ?>
                      <form class="search-area" method="get" id="searchform" action="<?php echo esc_url(home_url('/')); ?>" role="<?php echo esc_attr('search') ?>">
              ...
              <div class="topbar-right">
                  <div class="support-and-language-area">
                      <?php if (!empty(Egns\Helper\Egns_Helper::egns_get_theme_option('header_support_button_link_and_text', 'text'))) : ?>
                          <a href="<?php echo esc_url(Egns\Helper\Egns_Helper::egns_get_theme_option('header_support_button_link_and_text', 'url')); ?>"><?php echo esc_html(Egns\Helper\Egns_Helper::egns_get_theme_option('header_support_button_link_and_text', 'text')); ?></a>
                      <?php endif; ?>
                      <?php if (!empty(\Egns\Helper\Egns_Helper::egns_get_theme_option('header_language_shortcode'))) : ?>
                          <div class="language-area">
                              <?php
                                if (\Egns\Helper\Egns_Helper::egns_get_theme_option('header_language_enable') == 1) {
                                    echo do_shortcode(\Egns\Helper\Egns_Helper::egns_get_theme_option('header_language_shortcode'));
                                }
                                ?>
                          </div>
                      <?php endif; ?>
                  </div>
                  <?php if (Egns_Helper::egns_get_theme_option('header_login_switcher') == true) : ?>
  ...
  <header class="style-1">
      <div class="container d-flex flex-nowrap align-items-center justify-content-between">
          ...
          <?php else :
                Egns\Helper\Egns_Helper::get_theme_logo_mobile(NULL);
            endif; ?>
          <div class="main-menu">
              ...
              <div class="contact-area d-lg-none d-flex">
                  <?php $contact_list = Egns\Helper\Egns_Helper::egns_get_theme_option('header_one_contact_lists'); ?>
                  <?php if (!empty($contact_list)) : ?>
                      <div class="single-contact">
                          <?php if (!empty($contact_list[0]['header_info_icon']['url'])) : ?>
                              <div class="icon">
                                  <img src="<?php echo esc_url($contact_list[0]['header_info_icon']['url']); ?>" alt="<?php echo esc_attr__('icon-image', 'gofly'); ?>">
                              </div>
                          <?php endif; ?>
                          <div class="content">
                              <?php if (!empty($contact_list[0]['header_info_label'])) : ?>
                                  <span><?php echo esc_html($contact_list[0]['header_info_label']); ?></span>
                              <?php endif; ?>
                              <?php if (!empty($contact_list[0]['header_info_link']['text'])) : ?>
                                  <a href="<?php echo esc_url($contact_list[0]['header_info_link']['url']); ?>">
                                      <?php echo esc_html($contact_list[0]['header_info_link']['text']); ?>
                                  </a>
                              <?php endif; ?>
                          </div>
                      </div>
                      <?php if (count($contact_list) > 1) : ?>
                          <i class="bi bi-caret-down-fill contact-dropdown-btn"></i>
                          <ul class="contact-list">
                              <?php foreach (array_slice($contact_list, 1) as $contact_data) : ?>
                                  <li class="single-contact">
                                      <?php if (!empty($contact_data['header_info_icon']['url'])) : ?>
                                          <div class="icon">
                                              <img src="<?php echo esc_url($contact_data['header_info_icon']['url']); ?>" alt="<?php echo esc_attr__('icon-image', 'gofly'); ?>">
                                          </div>
                                      <?php endif; ?>
                                      <div class="content">
                                          <?php if (!empty($contact_data['header_info_label'])) : ?>
                                              <span><?php echo esc_html($contact_data['header_info_label']); ?></span>
                                          <?php endif; ?>
                                          <?php if (!empty($contact_data['header_info_link']['text'])) : ?>
                                              <a href="<?php echo esc_url($contact_data['header_info_link']['url']); ?>">
                                                  <?php echo esc_html($contact_data['header_info_link']['text']); ?>
                                              </a>
                                          <?php endif; ?>
                                      </div>
                                  </li>
              ...
              <?php if (Egns_Helper::egns_get_theme_option('header_login_switcher') == true) : ?>
                  <?php if (is_user_logged_in()) { ?>
                      <a href="<?php echo get_permalink(get_option('woocommerce_myaccount_page_id')); ?>" title="<?php esc_attr_e('My Account', 'gofly'); ?>" class="primary-btn1 black-bg d-lg-none d-flex">
                          <span>
                              <svg width="15" height="15" viewBox="0 0 15 15" xmlns="http://www.w3.org/2000/svg">
                                  <g>
                                      <path
                  ...
                  <?php } else { ?>
                      <a href="<?php echo get_permalink(get_option('woocommerce_myaccount_page_id')); ?>" title="<?php _e('Login / Register', 'gofly'); ?>" class="primary-btn1 black-bg d-lg-none d-flex">
                          <span>
                              <svg width="15" height="15" viewBox="0 0 15 15" xmlns="http://www.w3.org/2000/svg">
                                  <g>
                                      <path

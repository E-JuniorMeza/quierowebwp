        ...
        <div class="topbar-wrap">
            <ul class="contact-list">
                <li class="single-contact">
                    <?php if (!empty(Egns\Helper\Egns_Helper::egns_get_theme_option('header_six_contact_phone_icon', 'url'))) : ?>
                        <div class="icon">
                            <?php
                            echo Egns\Helper\Egns_Helper::gofly_display_icon_image(Egns\Helper\Egns_Helper::egns_get_theme_option('header_six_contact_phone_icon', 'url'), 'icon-image');
                            ?>
                        </div>
                    <?php endif; ?>
                    <?php if (!empty(Egns\Helper\Egns_Helper::egns_get_theme_option('header_six_contact_phone_link', 'text'))) : ?>
                        <a href="<?php echo esc_url(Egns\Helper\Egns_Helper::egns_get_theme_option('header_six_contact_phone_link', 'url')); ?>"><?php echo esc_html(Egns\Helper\Egns_Helper::egns_get_theme_option('header_six_contact_phone_link', 'text')); ?></a>
                    <?php endif; ?>
                </li>
                <li class="single-contact">
                    <?php if (!empty(Egns\Helper\Egns_Helper::egns_get_theme_option('header_six_contact_email_icon', 'url'))) : ?>
                        <div class="icon">
                            <?php
                            echo Egns\Helper\Egns_Helper::gofly_display_icon_image(Egns\Helper\Egns_Helper::egns_get_theme_option('header_six_contact_email_icon', 'url'), 'icon-image');
                            ?>
                        </div>
                    <?php endif; ?>
                    <?php if (!empty(Egns\Helper\Egns_Helper::egns_get_theme_option('header_six_contact_email_link', 'text'))) : ?>
                        <a href="<?php echo esc_url(Egns\Helper\Egns_Helper::egns_get_theme_option('header_six_contact_email_link', 'url')); ?>"><?php echo esc_html(Egns\Helper\Egns_Helper::egns_get_theme_option('header_six_contact_email_link', 'text')); ?></a>
                    <?php endif; ?>
                </li>
            </ul>
            ...
            <div class="topbar-right">
                <div class="support-and-language-area">
                    <?php if (!empty(Egns\Helper\Egns_Helper::egns_get_theme_option('header_six_contact_support_text_and_link', 'text'))) : ?>
                        <a href="<?php echo esc_url(Egns\Helper\Egns_Helper::egns_get_theme_option('header_six_contact_support_text_and_link', 'url')); ?>"> <?php echo esc_html(Egns\Helper\Egns_Helper::egns_get_theme_option('header_six_contact_support_text_and_link', 'text')); ?></a>
                    <?php endif; ?>
                    <?php if (!empty(\Egns\Helper\Egns_Helper::egns_get_theme_option('header_six_language_shortcode'))) : ?>
                        <div class="language-area">
                            <?php
                            if (\Egns\Helper\Egns_Helper::egns_get_theme_option('header_six_language_enable') == 1) {
                                echo do_shortcode(\Egns\Helper\Egns_Helper::egns_get_theme_option('header_six_language_shortcode'));
                            }
                            ?>
                        </div>
                    <?php endif; ?>
                ...
                <div class="search-and-login">
                    ...
                    <?php if (Egns_Helper::egns_get_theme_option('header_six_login_switcher') == true) : ?>
                        <?php if (is_user_logged_in()) { ?>
                            <a href="<?php echo get_permalink(get_option('woocommerce_myaccount_page_id')); ?>" title="<?php esc_attr_e('My Account', 'gofly'); ?>" class="primary-btn1 three black-bg">
                                <span>
                        ...
                        <?php } else { ?>
                            <a href="<?php echo get_permalink(get_option('woocommerce_myaccount_page_id')); ?>" title="<?php _e('Login / Register', 'gofly'); ?>" class="primary-btn1 three black-bg">
                                <span>
                                    <svg width="15" height="15" viewBox="0 0 15 15" xmlns="http://www.w3.org/2000/svg">
                                        <g>
                                            <path
...
<header class="style-1 two">
    <div class="container d-flex flex-nowrap align-items-center justify-content-lg-center justify-content-between">
        <?php if (!empty($page_header_mobile_logo)) : ?>
            <a href="<?php echo esc_url(home_url('/')); ?>" class="header-logo d-lg-none d-block">
                <img src="<?php echo esc_url($page_header_mobile_logo); ?>" alt="<?php echo esc_attr__('logo-image', 'gofly'); ?>">
            </a>
        <?php elseif (!empty($header_mobile_logo)) : ?>
            <a href="<?php echo esc_url(home_url('/')); ?>" class="header-logo d-lg-none d-block">
                <img src="<?php echo esc_url($header_mobile_logo); ?>" alt="<?php echo esc_attr__('logo-image', 'gofly'); ?>">
            </a>
        <?php else :
            Egns\Helper\Egns_Helper::get_theme_logo(NULL);
        endif; ?>
        <div class="main-menu">
            ...
            <div class="language-and-login-area d-lg-none d-block">
                ...
                <?php if (Egns_Helper::egns_get_theme_option('header_six_login_switcher') == true) : ?>
                    <?php if (is_user_logged_in()) { ?>
                        <a href="<?php echo get_permalink(get_option('woocommerce_myaccount_page_id')); ?>" title="<?php esc_attr_e('My Account', 'gofly'); ?>" class="primary-btn1 black-bg">
                            <span>
                                <svg width="15" height="15" viewBox="0 0 15 15" xmlns="http://www.w3.org/2000/svg">
                                    <g>
                                        <path
                    ...
                    <?php } else { ?>
                        <a href="<?php echo get_permalink(get_option('woocommerce_myaccount_page_id')); ?>" title="<?php _e('Login / Register', 'gofly'); ?>" class="primary-btn1 black-bg">
                            <span>
                                <svg width="15" height="15" viewBox="0 0 15 15" xmlns="http://www.w3.org/2000/svg">
                                    <g>
                                        <path

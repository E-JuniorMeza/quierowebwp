        ...
        <div class="topbar-wrap">
            <div class="logo-and-search-area">
                ...
                <form class="search-area" method="get" id="searchform" action="<?php echo esc_url(home_url('/')); ?>" role="<?php echo esc_attr('search') ?>">
                    <div class="form-inner">
                        ...
                        <input type="text" id="s" name="s" placeholder="<?php echo esc_attr__('Tour Package, Experiences, Destination', 'gofly') ?>">
            ...
            <div class="topbar-right">
                <div class="support-and-language-area">
                    <?php if (!empty(Egns\Helper\Egns_Helper::egns_get_theme_option('header_seven_contact_support_text_and_link', 'text'))) : ?>
                        <a href="<?php echo esc_url(Egns\Helper\Egns_Helper::egns_get_theme_option('header_seven_contact_support_text_and_link', 'url')); ?>"><?php echo esc_html(Egns\Helper\Egns_Helper::egns_get_theme_option('header_seven_contact_support_text_and_link', 'text')); ?></a>
                    <?php endif; ?>
                    <?php if (!empty(\Egns\Helper\Egns_Helper::egns_get_theme_option('header_seven_language_shortcode'))) : ?>
                        <div class="language-area">
                            <?php
                            if (\Egns\Helper\Egns_Helper::egns_get_theme_option('header_seven_language_enable') == 1) {
                                echo do_shortcode(\Egns\Helper\Egns_Helper::egns_get_theme_option('header_seven_language_shortcode'));
                            }
                            ?>
                        </div>
                    <?php endif; ?>
                </div>
                <?php if (Egns_Helper::egns_get_theme_option('header_seven_login_switcher') == true) : ?>
                    <?php if (is_user_logged_in()) { ?>
                        <a href="<?php echo get_permalink(get_option('woocommerce_myaccount_page_id')); ?>" title="<?php esc_attr_e('My Account', 'gofly'); ?>" class="primary-btn1 four transparent">
                            <span>
                    ...
                    <?php } else { ?>
                        <a href="<?php echo get_permalink(get_option('woocommerce_myaccount_page_id')); ?>" title="<?php _e('Login / Register', 'gofly'); ?>" class="primary-btn1 four transparent">
                            <span>
                                <svg width="15" height="15" viewBox="0 0 15 15" xmlns="http://www.w3.org/2000/svg">
                                    <g>
                                        <path

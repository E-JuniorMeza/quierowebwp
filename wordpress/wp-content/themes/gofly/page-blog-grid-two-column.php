 ...
 *
 * Template Name: Blog Grid Two Column Template
 *
        ...
        <div class="row gy-5">
            ...
            if ($wp_query->have_posts()) {
                ...
                while ($wp_query->have_posts()):
                    ...
                    echo apply_filters('egns_filter_blog_single_template', Egns\Helper\Egns_Helper::egns_get_template_part('blog', 'templates/grid-two-column/post/post', get_post_format() ? get_post_format() : 'default'));

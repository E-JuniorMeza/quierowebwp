...
<div class="package-grid-page pt-100 mb-100">
    <div class="container">
        <div class="row">
            <?php if (Egns_Helper::egns_get_theme_option('exp_sidebar_filter') == false) : ?>
                <div class="col-lg-4">
                    <?php Egns\Helper\Egns_Helper::egns_template_part('experience', 'sidebar-filter'); ?>
                </div>
            <?php endif; ?>
            <div class="<?php echo Egns_Helper::egns_get_theme_option('exp_sidebar_filter') == false ? 'col-lg-8' : 'col-lg-12' ?>">
                <?php
                if (Egns_Helper::egns_get_theme_option('exp_topbar_filter') == false) {
                    Egns\Helper\Egns_Helper::egns_template_part('experience', 'topbar-filter');
                }
                Egns\Helper\Egns_Helper::egns_template_part('experience', 'archive');
                ?>
                <?php
                global $wp_query;
